      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-center">
        ...
        <div className="md:w-1/2 flex justify-center md:justify-start mb-6 md:mb-0">
          <div className="text-left">
            ...
            <ul>
              ...
              <li className="mb-2">
                <a href="/pesquisa" className="hover:underline">Linhas de Pesquisa</a>
              </li>
              <li>
        ...
        <div className="md:w-1/2 flex justify-center md:justify-start">
          <div className="text-left">
            ...
            <ul>
              <li className="mb-2">
                <a href="https://www.instagram.com/npca.ufra/" className="flex items-center hover:underline">
              ...
              <li>
                <a href="https://www.youtube.com/@nucleodepesquisasemcomputa1776" className="flex items-center hover:underline">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-youtube mr-2" viewBox="0 0 16 16">
